...
.PHONY: help test lint lint-py lint-sh syntax-sh check fix install uninstall
...
help:
	@echo "targets: test  lint  lint-py  lint-sh  syntax-sh  check  fix  install  uninstall"
...
check: test lint syntax-sh ## everything CI runs, locally
